/* 
 * $Id: igmpv1.c,v 5.18 2011-03-11 11:17:28-03 nbrito Exp $
 */
...
/* Function Name: IGMPv1 packet header configuration.
   ...
   Targets:       N/A */
inline const void * igmpv1(const socket_t fd, const struct config_options o){
	/* GRE options size. */
	...
	igmpv1        = (struct igmphdr *)((u_int8_t *)ip + sizeof(struct iphdr) + greoptlen);
