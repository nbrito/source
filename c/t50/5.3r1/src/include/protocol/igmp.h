/* 
 * $Id: igmp.h,v 5.1 2011-03-09 10:01:48-03 nbrito Exp $
 */
...
/* GLOBAL IGMP PROTOCOL DEFINITIONS

   Global IGMP protocol definitions used by code.
   Any new global IGMP protocol definition should be added in this section. */
/* IGMP Header DEFINITIONS. */
#ifdef  IGMPV3_TLEN_NSRCS
#	warning "Sorry! The t50 is disabling IGMPV3_TLEN_NSRCS!"
#	undef  IGMPV3_TLEN_NSRCS
#	define IGMPV3_TLEN_NSRCS(foo) \
			(foo * sizeof(in_addr_t))
#else   /* IGMPV3_TLEN_NSRCS */
#	define IGMPV3_TLEN_NSRCS(foo) \
			(foo * sizeof(in_addr_t))
#endif  /* IGMPV3_TLEN_NSRCS */
/* Calculating IGMPv3 Header length */
#ifdef  igmpv3_hdr_len
#	warning "Sorry! The t50 is disabling igmpv3_hdr_len!"
#	undef  igmpv3_hdr_len
