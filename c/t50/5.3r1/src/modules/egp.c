/* 
 * $Id: egp.c,v 5.19 2011-04-17 11:38:38-03 nbrito Exp $
 */
...
static int8_t * revision = "$Revision: 5.19 $";
...
/* Function Name: EGP packet header configuration.
   ...
   Targets:       N/A */
inline const void * egp(const socket_t fd, const struct config_options o){
	/* GRE options size. */
	...
	static struct egp_hdr * egp;
	static struct egp_acq_hdr * egp_acq;
	...
	egp           = (struct egp_hdr *)((u_int8_t *)ip + sizeof(struct iphdr) + greoptlen);
