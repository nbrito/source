/* 
 * $Id: igmpv3.c,v 5.23 2011-04-17 11:38:38-03 nbrito Exp $
 */
...
/* Function Name: IGMPv3 packet header configuration.
   ...
   Targets:       N/A */
inline const void * igmpv3(const socket_t fd, const struct config_options o){
	/* GRE options size. */
	...
	static struct igmpv3_query * igmpv3_query;
	static struct igmpv3_report * igmpv3_report;
	static struct igmpv3_grec * igmpv3_grec;
	...
	if(o.igmp.type == IGMPV3_HOST_MEMBERSHIP_REPORT){
		...
		igmpv3_report           = (struct igmpv3_report *)((u_int8_t *)ip + sizeof(struct iphdr) + greoptlen);
		...
		checksum = (u_int8_t *)igmpv3_report + offset;
		...
		igmpv3_report->csum     = o.bogus_csum ? \
			                          __16BIT_RND(0) : \
		                          cksum((u_int16_t *)igmpv3_report, offset);
	}else{
		/* IGMPv3 Query Header structure making a pointer to Packet. */
		igmpv3_query           = (struct igmpv3_query *)((u_int8_t *)ip + sizeof(struct iphdr) + greoptlen);
		...
		/* Storing both Checksum and Packet. */
		checksum = (u_int8_t *)igmpv3_query + offset;
		...
		igmpv3_query->csum     = o.bogus_csum ? \
			                         __16BIT_RND(0) : \
		                         cksum((u_int16_t *)igmpv3_query, offset);
	}
