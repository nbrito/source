/* 
 * $Id: ripv1.c,v 5.21 2011-04-17 11:38:39-03 nbrito Exp $
 */
...
static int8_t * revision = "$Revision: 5.21 $";
...
/* Function Name: RIPv1 packet header configuration.
   ...
   Targets:       N/A */
inline const void * ripv1(const socket_t fd, const struct config_options o){
	/* GRE options size. */
