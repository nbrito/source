...
/* Nelson Brito <nbrito@sekure.org>
   $Id: common.h,v 1.12 2008-08-23 12:00:37-03 nbrito Exp $ */
#define __VERSION "2.2r" 
#ifndef __linux__
#error "Sorry! The b52 program was only tested under Linux!"
#endif  /* __linux__ */
...
struct options{
	...
	u_int64_t length;        /* general packet length        */
};
