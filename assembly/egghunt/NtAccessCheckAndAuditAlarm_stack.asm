...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
IFNDEF	NTACCESSCHECKANDAUDITALARM_STACK_ASM__
	NTACCESSCHECKANDAUDITALARM_STACK_ASM__	equ	<1>
.686
...
NtAccessCheckAndAuditAlarm_stack PROC
		start:
			xor		edx, edx
		inc_page:
			or		dx, 0FFFh
		...
		egg_found:
			jmp		edi
NtAccessCheckAndAuditAlarm_stack ENDP

.DATA

ELSE
	echo Sorry! Duplicate assembly component file NtAccessCheckAndAuditAlarm_stack.asm!
ENDIF
